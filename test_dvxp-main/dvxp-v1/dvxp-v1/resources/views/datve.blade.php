            ...
            <section class="d-flex justify-content-center" style="color: rgb(255, 255, 255); background-color: rgb(31, 31, 31); border-radius: 25px;">
                <div class="container" style="margin: 50px;">
                    <div class="row" style="display: flex; justify-content: center; flex-wrap: wrap;">
                        <div class="col-3">
                            <div class="t"><img src="{{ asset('storage/' . $phim->image) }}" alt="" height="500" width="300"></div>
                        </div>
                        <div class="col-8 tt" style="margin-left: 20px;">
                            <h4>{{ $phim->tenphim }}</h4>
                            <div style="height: 10px; border-bottom: 1px solid rgb(161, 161, 161);"></div>
                            <p>
                                <b>Đạo diễn: </b>{{ $phim->daodien }}<br>
                                <b>Thể loại: </b>{{ $phim->theloai }} <br>
                                <b>Nội dung: </b>{{ Str::of($phim->noidung)->limit(70) }} <br>
                            </p>
                        </div>
                    </div>
                    <div class="row d-flex justify-content-center">
                        <form action="{{ url('datve1/id='.$phim->id) }}" method="get" class="row d-flex justify-content-center">
                            <button class="btn btn-secondary" style="width: 100px;">Mua vé</button>
                        </form >
                    </div>
                </div>
            </section>
