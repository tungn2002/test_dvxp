                ...
                <div class="container" style="margin: 50px;">
                    <div class="row" style="display: flex; justify-content: center; flex-wrap: wrap;">
                        ...
                        <div class="col-8 tt" style="margin-left: 20px;">
                            ...
                            <form action="{{ url('datve2') }}" method="post">
                             @csrf   
                            <input name="idphim" type="text" class="form-control" value="{{$idphim}}" hidden>                            
                            <input name="ngaychieu" type="text" class="form-control" value="{{$item->ngaychieu}}" hidden>                            
                            <button type="submit" class="btn btn-primary" style="margin-top: 20px;">{{$item->ngaychieu}}</button>
                        </form>
                            @endforeach
                        @endisset
                        </div>
